                ...
                <ul class="navbar-nav mx-auto fw-bold">
                    ...
                    <li class="ligne nav-item dropdown mx-4 ">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item" href="{{route("personalBranding")}}">PERSONAL BRANDING</a></li>
                    ...
                    <li class="nav-item d-none d-sm-block">
                        <a class="nav-link img-layout" href={{ route("index")}}>
                            <img src="{{ asset('img/logo_MIA.png') }}" class="logo img-fluid "
                                 alt="logo">
                        </a>
                    </li>
                    <li class="ligne nav-item dropdown mx-4 ">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li class=""><a class="dropdown-item" href="{{ route("aPropos") }}">A PROPOS</a></li>
