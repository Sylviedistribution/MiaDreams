<footer>
    ...
    <div class="row d-sm-flex-row  my-5 col-md-12    justify-content-between ">
        <div class="col-md-2 ">
        ...
        <div class="col-md-2">
            ...
            <div class="d-flex flex-row ">
                <img src={{ asset('img/facebook.png') }} alt="" class=" logo-sociaux img-fluid " alt="">
                <img src={{ asset('img/instagram.png') }} alt="" class="logo-sociaux img-fluid " alt="">
                <img src={{ asset('img/youtube.png') }} alt="" class="logo-sociaux img-fluid " alt="">
            </div>
            <div class="d-flex flex-row pb-2">
                <img src={{ asset('img/logo-linkedin.png') }} alt="" class="logo-sociaux img-fluid " alt="">
                <img src={{ asset('img/twitter.png') }} alt="" class="logo-sociaux img-fluid " alt="">
            </div>
        </div>
    </div>
