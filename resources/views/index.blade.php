...
<div class="home-container-1">
    <img id="home-image1" src="{{asset("img/home-image1.jpg")}}" alt="">
    <div class="info">
        <h1>RÉVOLUTION</h1>
        <h1>FASHION</h1>
        <h4>L'ARTISANAT EST AU CŒUR</h4>
        <h4>DE NOTRE METIER</h4>
    </div>
</div>
...
<div class="home-container-2">
    ...
    <div class="section-text">
        <h2><strong>“<br>Notre startup diffuse l’ensemble de la richesse culturelle du continent africain<br><span
                    id="crochet">”</span></strong></h2>
...
<div class="home-container-5">
    ...
    <div class="image-container-fashion">
        <img id="home-image5" src="{{asset("img/home-image5.jpg")}}">
    </div>
    <div class="section-text">
        <div class="titre1">
            <h6>NOUVEAU</h6>
            <p>OFFRE EN PERSONAL<br>
                BRANDING
            </p>
        </div>
        <!-- Description de l'offre -->
        <p class="paragraphe"> Une méthode et un accompagnement uniques au service de votre leadership, qui vous font
            gagner du temps. Nous
            allons vous aider à développer votre propre style, dans une démarche bienveillante. Notre approche
            structurée et ultra-professionnelle vous permettra de constituer un dressing digne de la Haute Couture.</p>
        <br><br>
        <!-- Bouton pour découvrir la brochure -->
        <a class="btn" style="background-color:#603512">DÉCOUVREZ NOTRE BROCHURE</a>
    </div>
</div>

<!-- Section "ETHICAL FASHION" -->
<div class="home-container-6">
    <div class="section-text">
        <div class="titre2">
            ETHICAL FASHION
        </div>
        ...
        <a class="btn animate__animated animate__bounce" style="background-color: #6d755c">NOS ENGAGEMENTS</a>
    </div>
    <!-- Image illustrant la m1ode éthique -->
    <img id="home-image6" src="{{asset("img/home-image6.jpg")}}" alt="">
</div>

<div class="home-container-7">
    <img id="home-image7" src="{{asset("img/home-image7.webp")}}" alt="">

    <div>
        <h3>NOS DERNIERS ARTICLES DE <span style="color: #EBCF3F">BLOG</span></h3><br>
        ...
        <a class="btn-2" style="background-color: #EBCF3F; color: black;">DECOUVREZ</a><br><br>
    </div>
</div>
<div class="home-container-8">
